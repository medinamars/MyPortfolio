const techStack = [
  ...
  { category: 'Cloud & DevOps', skills: ['Azure Functions', 'Azure Blob Storage', 'Azure Application Insights', 'Azure DevOps', 'Azure Key Vault', 'IIS', 'Apache', 'Nginx', 'HAProxy', 'Git', 'Hangfire', 'Docker'] },
