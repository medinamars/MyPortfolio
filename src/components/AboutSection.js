const techStack = [
  ...
  { category: 'Web & Mobile', skills: ['HTML5', 'CSS3', 'Bootstrap', 'SPA', 'RESTful APIs', 'OAuth2', 'RPC', 'SignalR', 'Firebase', 'iOS and Android App Development', 'App Store Connect', 'Google Play Console', 'Payment Integrations (Braintree, Stripe, PayPal, RedDot ...)'] },
  { category: 'Architecture & QA', skills: ['SOLID', 'OOP', 'TDD', 'SaaS', 'xUnit', 'NUnit', 'Agile', 'Scrum'] },
  { category: 'AI & ML', skills: ['Claude', 'DeepSeek', 'LM Studio', 'Llama.cpp', 'LiteLLM', 'vLLM', 'Opus', 'Qwen', 'Gemma', 'Gemini', 'GitHub Copilot', 'OpenClaw', 'Hermes', 'Microsoft ML'] },
